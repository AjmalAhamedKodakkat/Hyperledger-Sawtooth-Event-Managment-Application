 ...
 */
const FAMILY_NAME = 'Event_Managment_App';
...
function EventDataAddress(date) {
    let nameHash = hash("Event_Managment_App")
 ...
 */
function registration(context, name, date,location,info,signer) {
    let event_Address = EventDataAddress(date)
    let event_detail = [name,date,location,info,signer]
